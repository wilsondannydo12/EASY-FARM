...
<body class="animsition">
        ...
        <div class="page-content--bgf7">
            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                        <?php include 'php/locality_server.php'; ?>
                        <div class="col-xl-12">
                            <!-- PAGE CONTENT--> 
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">LOCALITY</h3>
                        <?php
                        if (isset($success)) { ?>
                                      ...
                                      <div class="table-data__tool">
                                          ...
                                          <div class="table-data__tool-right">
                                              <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#add">
                                                  <i class="zmdi zmdi-plus"></i>Register Location</button>
                                    ...
                                    <div style="overflow-x:auto;">
                                      <table class="table table-striped" id="_table" style="width:100%">
                                          ...
                                          <tbody>
                                            <?php 
                                                $i = 1;
                                                $qry = $db->prepare("SELECT * FROM location");
                                                $qry->execute();
                                                  ...
                                                  <td align="center">
                                                   <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      ...
                                                      <div class="dropdown-divider"></div>
                                                      <a class="dropdown-item delete_data" href="<?php echo(BASE_LINK); ?>/deletion/remove/<?php echo $result->id; ?>/location/locality" onclick="return confirm('Are you sure you want to delete this locality?')"><span class="fa fa-trash text-danger"></span> Delete</a>
                                                    </div>
                                                  </td>
                                                </tr>
                                                <?php $i++;  } ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">REGISTER LOCALITY</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <button type="submit" name="registerLocalityBtn" id="registerLocalityBtn" class="btn btn-primary">Submit</button>
                  </div>
                    </form>
                  </div>
          ...
          <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">UPDATE LOCALITY</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <div id="locality_details"></div>
                  </div>
            ...
            <div class="modal fade" id="status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <form action="" method="post">
                        <input type="hidden" name="status_id" id="locality_id">
                        <div class="col-12 col-md-12">
    ...
    <script type="text/javascript">
      function status(id) {
        document.getElementById('locality_id').value=id;
      }
      
      function edit(id) {
          jQuery.ajax({
          url: "php/fetch_locality_for_edit.php",
          data:{
            id : id
          },
          type: "POST",
              success:function(data){
                $("#locality_details").html(data);
