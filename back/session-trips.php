            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                      ...
                      $cus_trip_qry = $db->prepare("SELECT transport_order.*, vehicles.vehicle_name, vehicles.vehicle_img, vehicles.number_plate FROM transport_order INNER JOIN vehicles ON vehicles.id=transport_order.vehicle_id WHERE transport_order.status='in session'");
                    }else{
                      $cus_trip_qry = $db->prepare("SELECT transport_order.*, vehicles.vehicle_name, vehicles.vehicle_img, vehicles.number_plate FROM transport_order INNER JOIN vehicles ON vehicles.id=transport_order.vehicle_id WHERE transport_order.status='in session' AND vehicles.user_id='$cur_user_in'");
                    }
