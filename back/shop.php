        ...
        <div class="page-content--bgf7">
            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                        <?php include 'php/shop_server.php'; ?>
                        <div class="col-xl-12">
                            <!-- PAGE CONTENT--> 
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">SHOP LIST</h3>
                        <?php
                        if (isset($success)) { ?>
                                      ...
                                      <div class="table-data__tool">
                                          ...
                                          <div class="table-data__tool-right">
                                              <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#add">
                                                  <i class="zmdi zmdi-plus"></i>Register Shop</button>
                                    ...
                                    <div style="overflow-x:auto;">
                                      <table class="table table-striped" id="_table" style="width:100%">
                                          ...
                                          <tbody>
                                            <?php 
                                                $i = 1;
                                                $qry = $db->prepare("SELECT * FROM shop");
                                                $qry->execute();
                                                  ...
                                                  <td align="center">
                                                   <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      ...
                                                      <div class="dropdown-divider"></div>
                                                      <a class="dropdown-item delete_data" href="<?php echo(BASE_LINK); ?>/deletion/remove/<?php echo $result->id; ?>/shop/shop" onclick="return confirm('Are you sure you want to delete this shop?')"><span class="fa fa-trash text-danger"></span> Delete</a>
                                                    </div>
                                                  </td>
                                                </tr>
                                                <?php $i++;  } ?>
                  ...
                  <div class="modal-body">
                    <form action="" method="post">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="shop" name="shop" class="form-control" required>
                        </div><br>
                    <div class="modal-footer">
                    <button type="submit" name="addShopBtn" id="addShopBtn" class="btn btn-primary">Add</button>
                  </div>
                    </form>
                  </div>
            ...
            <div class="modal fade" id="status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <form action="" method="post">
                        <input type="hidden" name="status_id" id="shop_id">
                        <div class="col-12 col-md-12">
