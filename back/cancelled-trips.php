            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">SESSION TRIPS</h3>
                        <?php
                        if (isset($success)) { ?>
                      ...
                      $cus_trip_qry = $db->prepare("SELECT transport_order.*, vehicles.vehicle_name, vehicles.vehicle_img, vehicles.number_plate FROM transport_order INNER JOIN vehicles ON vehicles.id=transport_order.vehicle_id WHERE transport_order.status='in cancelled'");
                    }else{
                      $cus_trip_qry = $db->prepare("SELECT transport_order.*, vehicles.vehicle_name, vehicles.vehicle_img, vehicles.number_plate FROM transport_order INNER JOIN vehicles ON vehicles.id=transport_order.vehicle_id WHERE transport_order.status='in cancelled' AND vehicles.user_id='$cur_user_in'");
                    }
