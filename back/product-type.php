...
<body class="animsition">
        ...
        <div class="page-content--bgf7">
            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                        <?php include 'php/product_type_server.php'; ?>
                        <div class="col-xl-12">
                            <!-- PAGE CONTENT--> 
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">PRODUCT TYPE LIST</h3>
                        <?php
                        if (isset($success)) { ?>
                                      ...
                                      <div class="table-data__tool">
                                          ...
                                          <div class="table-data__tool-right">
                                              <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#add">
                                                  <i class="zmdi zmdi-plus"></i>Register Product Type</button>
                                    ...
                                    <div style="overflow-x:auto;">
                                      <table class="table table-striped" id="_table" style="width:100%">
                                          ...
                                          <tbody>
                                            <?php 
                                                $i = 1;
                                                $qry = $db->prepare("SELECT * FROM product_type");
                                                $qry->execute();
                                                  ...
                                                  <td align="center">
                                                   <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      ...
                                                      <div class="dropdown-divider"></div>
                                                      <a class="dropdown-item delete_data" href="<?php echo(BASE_LINK); ?>/deletion/remove/<?php echo $result->id; ?>/product_type/product-type" onclick="return confirm('Are you sure you want to delete this product Type?')"><span class="fa fa-trash text-danger"></span> Delete</a>
                                                    </div>
                                                  </td>
                                                </tr>
                                                <?php $i++;  } ?>
                  ...
                  <div class="modal-body">
                    <form action="" method="post">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="pro_type" name="pro_type" placeholder="Type..."  class="form-control"required>
                        </div><br>
                    <div class="modal-footer">
                    <button type="submit" name="addProTypeBtn" id="addProTypeBtn" class="btn btn-primary">Submit</button>
                  </div>
                    </form>
                  </div>
            ...
            <div class="modal fade" id="status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <form action="" method="post">
                        <input type="hidden" name="status_id" id="proType_id">
                        <div class="col-12 col-md-12">
    ...
    <script type="text/javascript">
      function status(id) {
        document.getElementById('proType_id').value=id;
      }

      function edit(id) {
          jQuery.ajax({
          url: "php/fetch_product_type_for_edit.php",
          data:{
            id : id
          },
          type: "POST",
              success:function(data){
                $("#pro_type_detail").html(data);
