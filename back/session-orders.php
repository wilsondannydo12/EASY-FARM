            ...
            <section>
                <div class="container"><br>
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">SESSION ORDERS</h3>
                        <?php
                        if (isset($success)) { ?>
                      ...
                      $cus_shipping_qry = $db->prepare("SELECT order_shipping.*, customers.phone FROM order_shipping INNER JOIN customers ON customers.id=order_shipping.customer WHERE (order_shipping.payment='awaiting' || order_shipping.payment='in process') OR (order_shipping.status='pending' || order_shipping.status='in process' || order_shipping.status='shipped')");
                    }else{
                      $cus_shipping_qry = $db->prepare("SELECT order_shipping.*, customers.phone FROM order_shipping INNER JOIN customers ON customers.id=order_shipping.customer WHERE (order_shipping.payment='awaiting' || order_shipping.payment='in process') OR (order_shipping.status='pending' || order_shipping.status='in process' || order_shipping.status='shipped')");
                    }
                                                  ...
                                                  <td align="center">
                                                   <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      ...
                                                      <a class="dropdown-item edit-data" <?php echo $hide_Btn; ?> href="javascript:void(0)" data-toggle="modal" data-target="#confirmPaymentModal" onclick="updateOrder('<?php echo $cus_shipping_result->id; ?>');"><span class="fa fa-edit text-primary"></span> Update  Order</a>
                                                    </div>
                                                  </td>
                                                </tr>
                                                <?php $i++;  } ?>
